...
public class MultiProviderSingleClientKeyedListenerTests
{
    private static readonly OutboxKey SomeKey = new("sample-provider", "client-key");
    private static readonly OutboxKey SomeOtherKey = new("sample-provider-2", "client-key");
    ...
    {
        var act = () => new MultiProviderSingleClientKeyedListener([
    ...
    {
        var act = () => new MultiProviderSingleClientKeyedListener([new OutboxKey("sample-provider", "client-key")]);
        act.Should().Throw<ArgumentException>();
    }
    ...
    {
        var sut = new MultiProviderSingleClientKeyedListener(ValidKeys);
